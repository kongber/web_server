...
static int s_callback(ares_socket_t socket_fd, int type,
                                         void *data) {
...
main(void)
{
    ...
    ares_set_local_dev(channel, "dummy0");

    ares_set_socket_callback(channel, s_callback, nullptr);

    ares_gethostbyname(channel, "baidu.com", AF_INET, callback, nullptr);
